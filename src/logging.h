...
#define WARN_NN(...) { \
  printf("WARN  [%s:%d] ", __FILE__, __LINE__); aprintf(__VA_ARGS__); \
}

#define ERROR_NN(...) { \
  printf("ERROR [%s:%d] ", __FILE__, __LINE__); aprintf(__VA_ARGS__); \
}

#define FATAL_NN(...) { \
  printf("FATAL [%s:%d] ", __FILE__, __LINE__); aprintf(__VA_ARGS__); \
}
